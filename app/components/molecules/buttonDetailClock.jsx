        ...
        if (clock[0].stopTime) {
            return (
                <Button extraClass="btn__detail btn__text btn__square--left purple__bg" onClick={handleRestart}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                    <path d="M16.9856 14.8436H2.925L5.7325 12.0348L5.26125 11.5636L1.67188 15.1536L5.26125 18.743L5.7325 18.2717L2.97063 15.5092H17.6525V9.51172H16.9862L16.9856 14.8436Z" fill="black" stroke="black" strokeWidth="0.5" />
                    <path d="M2.995 6.17969H17.05L14.265 8.96531L14.7362 9.43656L18.325 5.84781L14.7356 2.25781L14.2644 2.72906L17.0481 5.51406H2.32812V11.5116H2.99437L2.995 6.17969Z" fill="black" stroke="black" strokeWidth="0.5" />
                ...
                <div className="btn__detail btn__detail--split">
                    ...
                    <Button extraClass="btn__text btn__square--left btn__right purple__bg " onClick={handleStop}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                            <rect x="1.675" y="2.175" width="16.65" height="16.65" stroke="black" strokeWidth="1.35" />
                            <path d="M14.5 5.99951L5.49995 14.9996" stroke="black" strokeWidth="1.1251" />
                            <path d="M14.5 15L5.50005 6.00005" stroke="black" strokeWidth="1.12499" />
        ...
        if (clock[0].scheduledStartTime) {
            ...
            return (
                <div className="btn__detail btn__detail--split">
                    ...
                    <p className="btn__right">Start je moment vanaf {getDate(clock[0].scheduledStartTime).date}</p>
                </div>
            )
        }
    }
