...
const ButtonClockCard = ({ userId, clock, participants }) => {
    ...
    //made by Abby
    if (clock.abbyMade) {
        return <p className={(participants.includes(userId)) ? ' btn__card bg-img__green' : 'btn__card bg-img__none'}> <div className="btn__text btn__card__abby"> made by <svg className="btn__card__logo" xmlns="http://www.w3.org/2000/svg" width="624" height="213" viewBox="0 0 624 213" fill="none">
        ...
        </svg></div>  <img className='btn__icon btn__card__arrow' src={arrow} alt="een pijl" /> </p>
    }
