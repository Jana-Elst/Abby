                    ...
                    <div className="card__middle">
                        ...
                        <div className="card__clock">
                            <svg xmlns="http://www.w3.org/2000/svg" width="91" height="91" viewBox="0 0 91 91" fill="none">
                                <circle cx="45.5" cy="45.5" r="43.5" stroke="black" stroke-width="3" />
                                <mask id="path-2-inside-1_1522_32842" fill="white">
                                    <path d="M45.5 0.5C57.4347 0.5 68.8807 5.24106 77.3198 13.6802L45.5 45.5V0.5Z" />
                                </mask>
                                <path d="M45.5 0.5C57.4347 0.5 68.8807 5.24106 77.3198 13.6802L45.5 45.5V0.5Z" fill="black" stroke="black" stroke-width="2" mask="url(#path-2-inside-1_1522_32842)" />
                            </svg>
                        </div>
                    </div>
